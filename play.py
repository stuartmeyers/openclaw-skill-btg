...
def print_setup_status():
    ...
    if not has_identity:
        ...
        if display_name:
            print("Manual fallback after display name setup:")
            print("/btg setup link <owner-invite-code>")
        else:
            print("Manual fallback:")
            print("/btg setup name <display-name>")
            print("/btg setup link <owner-invite-code>")
    else:
...
def cmd_autopilot(api_key, profile_id, args):
    ...
    if action == "enable":
        ...
        print("Autopilot will not run by itself unless a host scheduler calls /btg autopilot tick.")
        return
...
def cmd_help_examples():
    ...
    print()
    print("AUTOPILOT")
    print("Autopilot requires a host scheduler to run /btg autopilot tick.")
    print_help_entry("/btg autopilot", "Show autopilot status")
    print_help_entry("/btg autopilot enable 3", "Save autopilot settings")
    ...
    print_help_entry("/btg autopilot tick", "Run one scheduler check, normally called by cron/systemd/OpenClaw scheduler")
    print()
    print("REPORTS")
...
def cmd_help(args=None):
    ...
    print("Autopilot requires a host scheduler to run /btg autopilot tick.")
    print_help_entry("/btg autopilot", "Show autopilot status")
    print_help_entry("/btg autopilot enable", "Save autopilot settings")
    print_help_entry("/btg autopilot enable <rounds-per-day>", "Save autopilot settings with a daily cap")
    print_help_entry("/btg autopilot disable", "Disable autopilot")
    ...
    print_help_entry("/btg autopilot tick", "Run one scheduler check; if due, play one round and emit AUTOPILOT_NOTIFY when enabled")
    print()
    print("REPORTS")
